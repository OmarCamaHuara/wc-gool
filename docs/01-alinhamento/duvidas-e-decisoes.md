...
**Respondida em 2026-07-09 → ADR-010**: v1 leva **F-IA-1 (TL;DR de ideia + tradução)** e
**F-IA-5 (moderação assistida)**; F-IA-2/3/4 na v1.x; F-IA-6 na v2; agentes/picks nunca.
...
### T-08 ✅ Provedor de LLM
**Respondida em 2026-07-09 → ADR-010**: **modelos abertos self-hosted**. Restrição derivada:
o custo de infra de inferência entra no orçamento de T-05 (ainda em aberto) e a Fase 2
especifica a camada de inferência como serviço isolado/plugável.
